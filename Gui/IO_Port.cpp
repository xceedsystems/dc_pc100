        ...
        HDriverErr FAR& rDe)
{
    ...
    if( parrNetwork != NULL )
    {
        ...
        {
            CNetwork* pNetwork = new CNetwork( lpNetName, parrNetwork->m_ProjPath );
        ...
        DEVPARAM &      rDp)
{
    ...
    if( Device.Header.DevcfgId == STATIONCONFIG_ID )
    {
        rDp = (DEVPARAM)Device.Station.Address;
    }
    else
    {
        DEVPARAM param = (DEVPARAM)Device.Module.Slot << 16;
