...
#define IDS_IOPORT_BASE               0                           /* We may want the base set to 0, 
                                                                                  to preserve the manufacturer's error codes */
                                                              
#define IDS_IOPORT_HW_TEST            ( IDS_IOPORT_BASE + 1 )   /* Hardware test failed                                  */
#define IDS_IOPORT_INVALID_ADDERSS    ( IDS_IOPORT_BASE + 2 )   /* Address is out of range                               */
#define IDS_IOPORT_DEVICE_OFFLINE     ( IDS_IOPORT_BASE + 3 )   /* Address points to an offline device                   */
#define IDS_IOPORT_TIMEOUT            ( IDS_IOPORT_BASE + 4 )   /* Timeout error for this function                       */
#define IDS_IOPORT_READ_SIZE          ( IDS_IOPORT_BASE + 5 )   /* Read  buffer too short                                */
#define IDS_IOPORT_WRITE_SIZE         ( IDS_IOPORT_BASE + 6 )   /* Write buffer too short                                */
#define IDS_IOPORT_RW_ZERO            ( IDS_IOPORT_BASE + 7 )   /* Zero bytes to be transferred                          */
#define IDS_IOPORT_DPR_OUT            ( IDS_IOPORT_BASE + 8 )   /* Out of DPR image                                      */
