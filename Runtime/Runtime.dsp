...
# ADD LINK32 RtFlat.lib DcFlat.lib CsFlat.lib cstart32.obj rt.lib ciff3m.lib /nologo /version:21076.20052 /stack:0x4000000,0x2000 /subsystem:console /map /debug /debugtype:both /machine:I386 /nodefaultlib /out:"\Program Files\VLC\Driver 6_X\Bin\Jobs\DC_PC100.rt3" /pdbtype:sept /libpath:"..\..\lib" /libpath:"..\..\intime\lib" /heap:0x100000,0x4000
...
# ADD LINK32 RtFlat.lib DcFlat.lib CsFlat.lib cstart32.obj rt.lib ciff3m.lib /nologo /version:21076.20052 /stack:0x100000,0x2000 /subsystem:console /pdb:none /map /debug /machine:I386 /nodefaultlib /out:"c:\Debug\DC_PC100.rta" /libpath:"..\..\lib" /libpath:"..\..\intime\lib" /heap:0x4000000,0x4000
